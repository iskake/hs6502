...
-- TODO? apparently some of these are wrong
...
assemble (Instruction ORA ZPY  (Just (Left val)))   = Right $ [0x11, val]
...
assemble (Instruction AND ZPX  (Just (Left val)))   = Right $ [0x21, val]
...
assemble (Instruction AND ZPY  (Just (Left val)))   = Right $ [0x31, val]
...
assemble (Instruction EOR ZPX  (Just (Left val)))   = Right $ [0x41, val]
...
assemble (Instruction EOR ZPY  (Just (Left val)))   = Right $ [0x51, val]
...
assemble (Instruction ADC ZPX  (Just (Left val)))   = Right $ [0x61, val]
...
assemble (Instruction ADC ZPY  (Just (Left val)))   = Right $ [0x71, val]
...
assemble (Instruction STA ZPX  (Just (Left val)))   = Right $ [0x81, val]
...
assemble (Instruction STA ZPY  (Just (Left val)))   = Right $ [0x91, val]
...
assemble (Instruction LDA ZPX  (Just (Left val)))   = Right $ [0xa1, val]
...
assemble (Instruction LDA ZPY  (Just (Left val)))   = Right $ [0xb1, val]
...
assemble (Instruction CMP ZPX  (Just (Left val)))   = Right $ [0xc1, val]
...
assemble (Instruction CMP ZPY  (Just (Left val)))   = Right $ [0xd1, val]
...
assemble (Instruction SBC ZPX  (Just (Left val)))   = Right $ [0xe1, val]
...
assemble (Instruction SBC ZPY  (Just (Left val)))   = Right $ [0xf1, val]
